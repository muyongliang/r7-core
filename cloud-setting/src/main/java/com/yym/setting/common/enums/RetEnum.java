package com.yym.setting.common.enums;
...
public enum RetEnum {
    ...
    RET_PARAM_TYPE_SQUARE("0104", "四方服务参数错误"),
    ...
    RET_BIZ_ALI__CREATE_FAIL("2018", "支付宝  下单失败"),
    RET_BIZ_ALI__QUERY_FAIL("2019", "支付宝  查询 失败"),
    ...
    RET_BIZ_NO_PAY_FAIL("1199", "查询订单状态，未支付"),


    //订单已过期
    RET_WAIT_MATCH_OUT("9019", "订单匹配超时"),

    //订单匹配冲
    RET_WAIT_MATCH("9020", "订单匹配中"),
