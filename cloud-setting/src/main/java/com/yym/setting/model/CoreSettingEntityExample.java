package com.yym.setting.model;

import java.util.ArrayList;
import java.util.Date;
import java.util.List;

public class CoreSettingEntityExample {
    ...
    public CoreSettingEntityExample() {
    ...
    public CoreSettingEntityExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }

    public CoreSettingEntityExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }

    public CoreSettingEntityExample page(Integer page, Integer pageSize) {
