...
public class Common {
    ...
    public class VideoFrame {
        ...
        /**
         * If VideoFrame is in H.265 format, then H.265 points to video data in H.265 format, YUV and JPG fields should not be used. See {@link Common#VideoH265Frame VideoH265Frame}.
         */
