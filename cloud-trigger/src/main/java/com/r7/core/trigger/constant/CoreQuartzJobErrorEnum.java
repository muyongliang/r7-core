...
public enum CoreQuartzJobErrorEnum implements IError {
    ...
    CORE_QUARTZ_JOB_SAVE_ERROR("core_quartz_job_save_error","定时任务添加失败"),
    CORE_QUARTZ_JOB_UPDATE_ERROR("core_quartz_job_update_error","定时任务修改失败"),
    ...
    CORE_QUARTZ_JOB_JOB_RESUME_ERROR("core_quartz_job_job_resume_error","恢复失败"),
    ...
    CORE_QUARTZ_JOB_JOB_IMMEDIATE_ERROR("core_quartz_job_job_immediate_error","立即执行失败"),
    ...
    CORE_QUARTZ_JOB_JOB_COUNT_COUNT_FAILURE_ERROR("core_quartz_job_job_count_count_failure_error",
                                                         "定时任务的执行总次数和失败次数修改失败"),
